      ...
      children: [
        ...
        const AppPanel(
          ...
          child: ExpansionTile(
            ...
            children: [
              OrchestratorPendingCommandsCard(showContainer: false),
              SizedBox(height: AppDimensions.spacingL),
              OrchestratorRecentEventsCard(showContainer: false),
              SizedBox(height: AppDimensions.spacingL),
              OrchestratorRuntimeSnapshotCard(showContainer: false),
            ],
          ),
        ),
      ],
