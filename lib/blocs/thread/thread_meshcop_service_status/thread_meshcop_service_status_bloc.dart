...
class ThreadMeshcopServiceStatusBloc extends Bloc<
    ThreadMeshcopServiceStatusEvent, ThreadMeshcopServiceStatusState> {
  ThreadMeshcopServiceStatusBloc()
      : super(ThreadMeshcopServiceStatusState.initial()) {
